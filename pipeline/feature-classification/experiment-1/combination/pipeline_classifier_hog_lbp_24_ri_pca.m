function pipeline_classifier_hog_lbp_24_ri_pca(classifier_name)
...
for idx_cv_lpo = 1:length(idx_class_pos)
    ...
    save(strcat(store_directory, ['predicition_hog_lbp_24_ri_pca', classifier_name, '.mat']), 'pred_label_cv');
